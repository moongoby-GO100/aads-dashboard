...
const PUBLIC_PATHS = ["/login", "/signup", "/invite/accept", "/impersonate", "/e2e-auth.html", "/docs", "/braming/shared", "/unni-naengmyeon", "/gomyunghee-naengmyeon", "/brands", "/fonts", "/apps", "/static", "/screenshots", "/_next", "/favicon.ico", "/api", "/manifest.json", "/manifest-kakaobot.json", "/icon-", "/apple-touch-icon.png", "/sw.js", "/manifest.webmanifest"];
