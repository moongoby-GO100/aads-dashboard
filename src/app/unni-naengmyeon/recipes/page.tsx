...
const mainRecipes: StepRecipe[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "다대기 150g(큰스푼 기준 3스푼)을 넣는다.",
      "토핑은 달걀 반쪽, 무김치, 오이, 깨가루, 땅콩가루 순서로 예쁘게 올린다.",
      "육수 1통 500cc를 함께 제공한다.",
    ],
  },
  {
    title: "언니냉면",
  ...
  },
  {
    ...
    steps: [
      "비빔냉면 레시피를 동일하게 준비한다.",
      "단, 매운다대기 100g(2스푼)과 다대기 50g(1스푼)을 추가한다.",
      "매운다대기 레시피: 육수 300cc, 베트남 고춧가루 100g, 냉면다대기 400g을 섞어 준비한다.",
    ],
  },
  {
    title: "명태회냉면",
  ...
  },
  {
    ...
    steps: [
      "묵 250g을 찬물에 2번 정도 흐르는 물로 씻고 물기를 빼서 냉면그릇에 담는다.",
      "묵 위에 자른 김치, 오이, 김가루 듬뿍, 깨가루, 참기름 조금을 올린다.",
      "육수 500cc는 육수그릇에 담는다.",
      "※ 묵은 실온에 보관한다. 냉장보관 시 묵이 끊어진다.",
    ],
  },
];
