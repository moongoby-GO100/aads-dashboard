...
async function fetchServerHealth(
  ...
  try {
    ...
    const headers: Record<string, string> = serverId === "116"
    ...
    // server-116: aads ops health-check 응답 파싱
    if (serverId === "116") {
      return {
        server_id: serverId,
        ip,
...
const SERVERS = [
  { id: "116", ip: "5.104.86.116", role: "AADS Backend (FastAPI / PostgreSQL / Dashboard)" },
  { id: "14",  ip: "5.104.86.14",  role: "GO100 운영 서버" },
  { id: "114", ip: "114.207.244.86", role: "실행 서버 (SF / NTV2 / NAS)" },
  { id: "211", ip: "211.188.51.113", role: "KIS legacy" },
];
