...
const EXPECTED_SERVERS: Array<{ id: string; name: string; ip: string }> = [
  { id: "116", name: "server-116 AADS", ip: "5.104.86.116" },
  { id: "contabo14", name: "server-14 GO100", ip: "5.104.86.14" },
  { id: "114", name: "server-114 SF/NTV2", ip: "114.207.244.86" },
  { id: "211", name: "서버211 KIS legacy", ip: "211.188.51.113" },
];
