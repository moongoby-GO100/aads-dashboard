...
export type DesignModificationCategory =
  | "layout"
  | "spacing"
  | "color_token"
  | "typography"
...
export type DesignModificationRequestStatus =
  | "draft"
  | "submitted"
  | "reviewing"
  | "planned"
...
export type DesignModificationRequestSource = "api" | "local_stub";

export interface DesignModificationClassifierScore {
  category: DesignModificationCategory;
  score: number;
  matched_terms: string[];
}

export interface DesignModificationClassification {
  suggested_category: DesignModificationCategory;
  confidence: number;
  scores: DesignModificationClassifierScore[];
}

export interface DesignModificationRequestDraft {
  title: string;
  category?: DesignModificationCategory;
  status?: DesignModificationRequestStatus;
...
export interface DesignModificationRequest {
  ...
  requester: string;
  notes: string;
  classification: DesignModificationClassification;
  created_at: string;
  updated_at: string;
...
export interface DesignModificationRequestListResponse {
  items: DesignModificationRequest[];
  total: number;
  source: DesignModificationRequestSource;
...
export interface DesignModificationRequestDetailResponse {
  item: DesignModificationRequest | null;
  source: DesignModificationRequestSource;
  api_available: boolean;
  message?: string;
  endpoint?: string;
...
export interface CreateDesignModificationRequestResponse {
  item: DesignModificationRequest;
  source: DesignModificationRequestSource;
  api_available: boolean;
  message?: string;
  endpoint?: string;
