...
const SERVERS: ServerStatus[] = [
  { name: "server-116 (AADS)", ip: "5.104.86.116", status: "unknown" },
  { name: "server-14 (GO100)", ip: "5.104.86.14", status: "unknown" },
  { name: "server-114 (SF/NTV)", ip: "114.207.244.86", status: "unknown" },
  { name: "서버 211 (KIS legacy)", ip: "211.188.51.113", status: "unknown" },
];
